...
(function() {
  ...
  this.actsAs = function() {
    ...
    return function(base) {
      return function() {
        var args, index, key, oldMethods, originalObjects, retVal, target, value, wrapper, _i, _j, _len, _len1;
        args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        originalObjects = [];
        ...
        for (index = _j = 0, _len1 = originalObjects.length; _j < _len1; index = ++_j) {
