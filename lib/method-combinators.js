...
(function() {
  ...
  this.splatterAt = function(index) {
    return function(funcRef) {
      return function() {
        var args, array, element, func, newArgs, _i, _len, _results;
        ...
        for (_i = 0, _len = array.length; _i < _len; _i++) {
          ...
          _results.push(func.apply(this, newArgs));
        }
        return _results;
      };
    };
  ...
  this.sed = function(transformRef) {
