...
(function() {
  ...
  this.branchOn = function(predicate) {
    return function(_arg) {
      var failure, success;
      failure = _arg.failure, success = _arg.success;
      return function() {
        if (predicate.apply(this, arguments)) {
          return success != null ? success.apply(this, arguments) : void 0;
        } else {
          return failure != null ? failure.apply(this, arguments) : void 0;
        }
      };
    };
  };
